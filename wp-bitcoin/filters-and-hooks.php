...
function wpbc_bitcoin_create_order_page() {
    register_post_type( 'wpbc_bitcoin_orders', array(
	'labels' => array(
	    'name'			 => "Bitcoin Orders",
...
function wpbc_bitcoin_add_meta_boxes() {
    add_meta_box( 'order_review_meta_box', "Order Review", 'wpbc_bitcoin_order_review_meta_box', 'wpbc_bitcoin_orders', 'normal', 'high'
    );
}
